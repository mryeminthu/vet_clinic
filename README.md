...
Clone this repository to your desired folder:
     ...
     cd my-folder
    git clone https://github.com/mryeminthu/vet_clinic.git
...
Feel free to check the [issues page](https://github.com/mryeminthu/vet_clinic/issues).
...
This project is [MIT](https://github.com/mryeminthu/vet_clinic/blob/create-animals-table/LICENSE) licensed.
